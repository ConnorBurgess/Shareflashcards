  ...
  return (
    <>
      <div id="info-popup"
        ...
        className="fixed left-0 z-50 w-4/12 h-24 p-3 text-green-800 bg-gray-700 border-r-2 border-gray-700 shadow-lg select-none rounded-r-md top-36 sm:w-2/12 sm:h-1/6 md:p-5 sm:text-3xl">
